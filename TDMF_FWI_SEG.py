...
class TDMF_FWI_SEG(nn.Module):
    def __init__(self):
        super(TDMF_FWI_SEG, self).__init__()
        ...
        self.trans_25 = UnifiedMSSTB(58, 512)
        self.trans_50 = UnifiedMSSTB(58, 256)
        self.trans_100 = UnifiedMSSTB(58, 128)
        self.trans_200 = UnifiedMSSTB(58, 64)
    ...
    def forward(self, x):
        ...
        trans_25 = self.trans_25(trans1, spatioUp4)  # (none, 512, 25, 38)
        spatioUp3 = self.spatioUp3(spatioDown3, trans_25)       # (none, 256, 50, 76)

        trans_50 = self.trans_50(trans1, spatioUp3)    # (none, 256, 50, 76)
        spatioUp2 = self.spatioUp2(spatioDown2, trans_50)       # (none, 128, 100, 151)

        trans_100 = self.trans_100(trans1, spatioUp2)   # (none, 128, 100, 151)
        spatioUp1 = self.spatioUp1(temporal2spatio1, trans_100)  # (none, 64, 200, 301)

        trans_200 = self.trans_200(trans1, spatioUp1)   # (none, 64, 200, 301)

        resUp1 = F.interpolate(trans_200, size=(201, 301), mode="bilinear")   # (none, 64, 201, 301)
